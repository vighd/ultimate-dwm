...
static Key keys[] = {
  ...
  { MODKEY|ShiftMask,             XK_n,           spawn,        SHCMD("termite -e iwctl")                                                                 },
  { MODKEY|ShiftMask,             XK_Return,      spawn,        SHCMD("termite")                                                                          },
  { MODKEY|ShiftMask,             XK_w,           spawn,        SHCMD("chromium")                                                                         },
  { MODKEY|ShiftMask,             XK_f,           spawn,        SHCMD("termite -e vifmrun")                                                               },
  { MODKEY|ShiftMask,             XK_s,           spawn,        SHCMD("termite -e alsamixer -c 0")                                                        },
  { 0,                            0x1008ff13,     spawn,        SHCMD("amixer set Master 3%+")                                                            },
  { 0,                            0x1008ff11,     spawn,        SHCMD("amixer set Master 3%-")                                                            },
  ...
  { 0,                            0x1008ff03,     spawn,        SHCMD("xbacklight -inc 5")                                                                },
  { 0,                            0x1008ff02,     spawn,        SHCMD("xbacklight -dec 5")                                                                },
  ...
  { MODKEY|ShiftMask,             XK_m,           spawn,        SHCMD("termite -e mocp && mocp -x")                                                       },
